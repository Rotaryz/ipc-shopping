...
export default {
   ...
   * @returns {Promise.<*>}
   */
  dataAllotMoney(activity_alliance_id = 1) {
   ...
   * @returns {Promise.<*>}
   */
  dataSelfShop(activity_alliance_id = 1, page) {
   ...
   * @returns {Promise.<*>}
   */
  dataSelfShopAllData(activity_alliance_id = 1) {
   ...
   * @returns {Promise.<*>}
   */
  dataAllStaff(activity_alliance_id = 1) {
   ...
   * @returns {Promise.<*>}
   */
  dataCake(activity_alliance_id = 1) {
   ...
   * @returns {Promise.<*>}
   */
  dataBar(activity_alliance_id = 1) {
