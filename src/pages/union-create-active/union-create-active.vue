      ...
      <section class="u-c-section active-info">
        <article class="a-i-item">
          ...
          <dd class="content">
            ...
            <div class="c-item">2. 商家销售卡的用户，到其他门店使用一次，得到联盟力<input class="c-input-info" id='activeInfo1' type="number" :value="activeInfo.item1 " maxlength="4" placeholder="10" placeholder-class="content" @input="inputHandler"/>分的奖励。（可以分全部联盟商家报名该活动的报名金）</div>
            <div class="c-item">3. 商家可以得到该活动全部商家的异业客户引流。</div>
          </dd>
        </article>
        <article class="a-i-item">
